 ...
 * with additional parameters by passing a {@link com.r0adkll.deadskunk.network.RequestParams} instance,
...
public class AsyncHttpClient {
    ...
    /**
     * Sets a Custom SSLSocketFactory
     * @param sslSocketFactory
     */
    public void setCustomSSLSocketFactory(SocketFactory sslSocketFactory){
        this.httpClient.getConnectionManager().getSchemeRegistry().register(new Scheme("https", sslSocketFactory, 443));
    }
   ...
   /**
    ...
    /**
     * Sets the NTLM authentication for request
     * @param user
     * @param pass
     */
    public void setNTAuth(String user, String pass){
        NTCredentials ntauth = new NTCredentials(user, pass, "", "");
        this.httpClient.getCredentialsProvider().setCredentials(AuthScope.ANY, ntauth);
    }
