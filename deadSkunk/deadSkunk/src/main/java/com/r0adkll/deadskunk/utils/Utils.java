...
public class Utils {
    ...
    public static String printTimeDuration(java.util.Date date, int maxDays){
        if(date == null) return "";
        ...
        int cDays = cdate.get(Calendar.DAY_OF_YEAR);
        int tDays = today.get(Calendar.DAY_OF_YEAR);

        int cHour = cdate.get(Calendar.HOUR_OF_DAY);
        int tHour = today.get(Calendar.HOUR_OF_DAY);

        int cMinute = cdate.get(Calendar.MINUTE);
        int tMinute = today.get(Calendar.MINUTE);

        int cSecond = cdate.get(Calendar.SECOND);
        int tSecond = today.get(Calendar.SECOND);

        int totalDays = tDays - cDays;
        ...
        if(cDays == tDays){
            ...
            if(cHour == tHour){
                ...
                if(cMinute == tMinute){
                    ...
                    int totalSeconds = tSecond - cSecond;
                    return String.valueOf(totalSeconds) + " s";

                }else{

                    int totalMinutes = tMinute - cMinute;
                ...
                int totalHours = tHour - cHour;
                return String.valueOf(totalHours) + " hrs";

            }

        }else{
            return String.valueOf(totalDays) + " days";
        }
    }
